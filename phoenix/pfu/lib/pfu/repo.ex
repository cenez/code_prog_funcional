defmodule Pfu.Repo do
  ...
  def tudo(Pfu.Usuario) do
    [%Pfu.Usuario{id: "1", name: "Manoel Silva", username: "manoel", password: "elixir"},
    %Pfu.Usuario{id: "2", name: "Pedro Costa", username: "pedro", password: "lang"},
    %Pfu.Usuario{id: "3", name: "Maria Oliveira", username: "maria", password: "phx"}]
  end
